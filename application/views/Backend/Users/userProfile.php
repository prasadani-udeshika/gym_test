            ...
            <li>
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('BPAllocate') ?>">User Profile</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><span>User Detailst</span></li>
                        </ol>
                    </nav>
                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="text-center user-info">
                                    <img src="assets/img/User/<?= $row->customer_img ?>" alt="avatar" width="300" height="200" style="border-radius: 50%;">
                                    <p class=""><?= $row->customer_name ?></p>
